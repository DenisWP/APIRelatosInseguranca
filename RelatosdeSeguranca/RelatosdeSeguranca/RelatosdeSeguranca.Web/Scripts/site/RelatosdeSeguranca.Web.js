var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
    var Administration;
    ...
    })(Administration = RelatosdeSeguranca.Administration || (RelatosdeSeguranca.Administration = {}));
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
    var Administration;
    (function (Administration) {
...
(function (RelatosdeSeguranca) {
    ...
    })(BasicSamples = RelatosdeSeguranca.BasicSamples || (RelatosdeSeguranca.BasicSamples = {}));
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = RelatosdeSeguranca.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = RelatosdeSeguranca.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = RelatosdeSeguranca.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (RelatosdeSeguranca) {
    ...
    })(Common = RelatosdeSeguranca.Common || (RelatosdeSeguranca.Common = {}));
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
    var Common;
...
(function (RelatosdeSeguranca) {
    ...
    })(Membership = RelatosdeSeguranca.Membership || (RelatosdeSeguranca.Membership = {}));
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
    var Membership;
...
(function (RelatosdeSeguranca) {
    ...
    })(Northwind = RelatosdeSeguranca.Northwind || (RelatosdeSeguranca.Northwind = {}));
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
    var Northwind;
...
(function (RelatosdeSeguranca) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'RelatosdeSeguranca.Northwind.Gender', 'RelatosdeSeguranca.Northwind.Entities.Gender');
    })(Northwind = RelatosdeSeguranca.Northwind || (RelatosdeSeguranca.Northwind = {}));
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
...
(function (RelatosdeSeguranca) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'RelatosdeSeguranca.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = RelatosdeSeguranca.Northwind || (RelatosdeSeguranca.Northwind = {}));
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
...
(function (RelatosdeSeguranca) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = RelatosdeSeguranca.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = RelatosdeSeguranca.LanguageList || (RelatosdeSeguranca.LanguageList = {}));
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
...
(function (RelatosdeSeguranca) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('RelatosdeSeguranca');
        Serenity.EntityDialog.defaultLanguageList = RelatosdeSeguranca.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = RelatosdeSeguranca.ScriptInitialization || (RelatosdeSeguranca.ScriptInitialization = {}));
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
    var Administration;
...
(function (RelatosdeSeguranca) {
    ...
    RelatosdeSeguranca.BasicProgressDialog = BasicProgressDialog;
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new RelatosdeSeguranca.BasicProgressDialog();
...
(function (RelatosdeSeguranca) {
    ...
    })(DialogUtils = RelatosdeSeguranca.DialogUtils || (RelatosdeSeguranca.DialogUtils = {}));
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
    var Common;
...
(function (RelatosdeSeguranca) {
    ...
    RelatosdeSeguranca.StaticTextBlock = StaticTextBlock;
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                RelatosdeSeguranca.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(RelatosdeSeguranca.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(RelatosdeSeguranca.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(RelatosdeSeguranca.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        RelatosdeSeguranca.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: RelatosdeSeguranca.Authorization.userDefinition.DisplayName,
...
(function (RelatosdeSeguranca) {
    ...
    (function (Northwind) {
        ...
        }(RelatosdeSeguranca.Common.GridEditorDialog));
...
(function (RelatosdeSeguranca) {
    ...
    (function (Northwind) {
        ...
        }(RelatosdeSeguranca.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return RelatosdeSeguranca.LanguageList.getValue();
            };
...
(function (RelatosdeSeguranca) {
    ...
    })(Authorization = RelatosdeSeguranca.Authorization || (RelatosdeSeguranca.Authorization = {}));
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
var RelatosdeSeguranca;
(function (RelatosdeSeguranca) {
    var BasicSamples;
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(RelatosdeSeguranca.Northwind.ProductDialog));
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(RelatosdeSeguranca.Northwind.ProductGrid));
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: RelatosdeSeguranca.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: RelatosdeSeguranca.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new RelatosdeSeguranca.Northwind.OrderDialog();
                        ...
                        var chai = RelatosdeSeguranca.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = RelatosdeSeguranca.Northwind.EmployeeRow.getLookup().items
        ...
        }(RelatosdeSeguranca.Northwind.OrderGrid));
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(RelatosdeSeguranca.Northwind.OrderDialog));
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    RelatosdeSeguranca.Northwind.CategoryService.Retrieve({
        ...
        }(RelatosdeSeguranca.Northwind.CategoryDialog));
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(RelatosdeSeguranca.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(RelatosdeSeguranca.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new RelatosdeSeguranca.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                RelatosdeSeguranca.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(RelatosdeSeguranca.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    RelatosdeSeguranca.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(RelatosdeSeguranca.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(RelatosdeSeguranca.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    RelatosdeSeguranca.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return RelatosdeSeguranca.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return RelatosdeSeguranca.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return RelatosdeSeguranca.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return RelatosdeSeguranca.Northwind.OrderService.baseUrl; };
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(RelatosdeSeguranca.Northwind.SupplierDialog));
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(RelatosdeSeguranca.Northwind.SupplierGrid));
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return RelatosdeSeguranca.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return RelatosdeSeguranca.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return RelatosdeSeguranca.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return RelatosdeSeguranca.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return RelatosdeSeguranca.Northwind.OrderService.baseUrl; };
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    RelatosdeSeguranca.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(RelatosdeSeguranca.Northwind.CustomerDialog));
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(RelatosdeSeguranca.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = RelatosdeSeguranca.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return RelatosdeSeguranca.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return RelatosdeSeguranca.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new RelatosdeSeguranca.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(RelatosdeSeguranca.Northwind.OrderDetailDialog));
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(RelatosdeSeguranca.Northwind.OrderDetailsEditor));
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return RelatosdeSeguranca.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return RelatosdeSeguranca.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return RelatosdeSeguranca.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return RelatosdeSeguranca.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return RelatosdeSeguranca.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        ...
        }(RelatosdeSeguranca.Common.BulkServiceAction));
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return RelatosdeSeguranca.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return RelatosdeSeguranca.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return RelatosdeSeguranca.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return RelatosdeSeguranca.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(RelatosdeSeguranca.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new RelatosdeSeguranca.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new RelatosdeSeguranca.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new RelatosdeSeguranca.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (RelatosdeSeguranca) {
    ...
    RelatosdeSeguranca.SelectableEntityGrid = SelectableEntityGrid;
})(RelatosdeSeguranca || (RelatosdeSeguranca = {}));
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return RelatosdeSeguranca.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return RelatosdeSeguranca.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return RelatosdeSeguranca.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return RelatosdeSeguranca.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(RelatosdeSeguranca.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = RelatosdeSeguranca.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            RelatosdeSeguranca.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return RelatosdeSeguranca.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return RelatosdeSeguranca.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return RelatosdeSeguranca.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return RelatosdeSeguranca.Northwind.ProductService.baseUrl; };
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return RelatosdeSeguranca.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return RelatosdeSeguranca.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return RelatosdeSeguranca.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return RelatosdeSeguranca.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return RelatosdeSeguranca.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return RelatosdeSeguranca.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (RelatosdeSeguranca) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return RelatosdeSeguranca.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return RelatosdeSeguranca.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return RelatosdeSeguranca.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=RelatosdeSeguranca.Web.js.map